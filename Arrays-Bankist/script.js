...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === Number(inputLoginPin.value)) {
    ...
    window.alert(`User does not exist or PIN was incorrect`);
...
btnClose.addEventListener('click', function (e) {
  ...
  if (
    ...
    // Delete account. Pretty dangerous this implimentation. Can delete all the accounts.
...
const dogsSahara = [9, 16, 6, 8, 3];
const dogAges = dogsJulia.concat(dogsSahara);
const checkDogs = function (array1, array2) {
  const dogAges = array1.concat(array2);
...
checkDogs(dogsJulia, dogsSahara);
...
const accountBalance2 = accounts
...
// 1.
dogs.forEach(arr => {
  arr.recommendedFood = Math.trunc(arr.weight ** 0.75 * 28);
});
console.log(dogs);
